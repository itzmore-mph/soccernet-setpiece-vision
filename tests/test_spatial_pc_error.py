...
from _pipeline_core import GRID_NX, GRID_NY, PITCH_LENGTH_M, expand_balls_to_frames  # noqa: E402
from spatial_pc_error import frame_surfaces  # noqa: E402
...
def test_expand_balls_broadcasts_clip_ball_to_all_frames():
    ...
    out = expand_balls_to_frames(balls, det)
    assert len(out) == 3
